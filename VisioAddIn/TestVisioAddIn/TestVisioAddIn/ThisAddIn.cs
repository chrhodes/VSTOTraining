...
using TestVisioAddInApplication;
    ...
    public partial class ThisAddIn
    {
        private void ThisAddIn_Startup(object sender, System.EventArgs e)
        {
            ...
            if (Common.EnableAppEvents)
            {
                ...
                {
                    Common.AppEvents = new TestVisioAddInApplication.Events.VisioAppEvents();
            ...
            Common.AddInApplicationEvents = new TestVisioAddInApplication.Events.AddInApplicationEvents();
