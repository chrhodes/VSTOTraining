    ...
    public partial class ThisAddIn
    {
        private void ThisAddIn_Startup(object sender, System.EventArgs e)
        {
            ...
            if (Common.EnableAppEvents)
            {
                ...
                {
                    Common.AppEvents = new VisioAddIn2Application.Events.VisioAppEvents();
            ...
            Common.AddInApplicationEvents = new VisioAddIn2Application.Events.AddInApplicationEvents();
