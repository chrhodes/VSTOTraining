    ...
    public partial class ThisAddIn
    {
        private void ThisAddIn_Startup(object sender, System.EventArgs e)
        {
            ...
            if (Common.EnableAppEvents)
            {
                ...
                {
                    Common.AppEvents = new VisioWpfPrismAddInApplication.Events.VisioAppEvents();
            ...
            Common.AddInApplicationEvents = new VisioWpfPrismAddInApplication.Events.AddInApplicationEvents();
